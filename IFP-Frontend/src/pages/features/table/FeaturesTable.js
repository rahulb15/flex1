...
import FormDialogAddFeatures from "../formDialog/FormDialogAddFeatures";
import FormDialogEditFeatures from "../formDialog/FormDialogEditFeatures";
import FormDialogDeleteFeatures from "../formDialog/FormDialogDeleteFeatures";
...
const FeaturesTable = ({ classes, ...props }) => {
                    ...
                    return (
                        <th key={columnMeta.index} style={{paddingRight: "16px"}}>
                            <div style={{display:"flex", flexDirection:"row", justifyContent:"flex-end"}}>
                                <FormDialogAddFeatures component={Paper}  
                                    create={props.create}
                                    refresh={refresh}
                                    featuresData={props.featuress}
                                />
                            </div>
                        </th>
                    );
            ...
            
            {
             ...
             options: {
                ...
                customBodyRender: (value, tableMeta, updateValue) => {
                    ...
                    return (
                        <div style={{display:"flex", flexDirection:"row", justifyContent:"flex-end"}}>
                            <FormDialogEditFeatures
                                dataFeatures={tableMeta.rowData}
                                update={props.update}
                            />
                            <FormDialogDeleteFeatures 
                                dataFeatures={tableMeta.rowData}
                                delete={props.delete}
                                refresh={refresh}
                            />
...
const mapStateToProps = state => ({
    featuress: state.features.featuress,
    meta: state.features.metaFeatures
})
...
export default connect(mapStateToProps, mapActionToProps)(withStyles(styles)(FeaturesTable));